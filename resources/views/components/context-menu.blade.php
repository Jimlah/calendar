<x-drop-down-menu x-contextmenu:contextmenu.event>
    <!-- An unexamined life is not worth living. - Socrates -->
            ...
            <x-drop-down-link x-on:click.prevent="$wire.paste(props); __isopen=false" >Calendar</x-drop-down-link>
            <x-drop-down-hr-line />
            ...
            <x-drop-down-link x-on:click.prevent="$wire.paste(props);__isopen=false">Paste</x-drop-down-link>
